...
schemas_props = create_schema_properties()
set_openapi_specs(schemas_properties=schemas_props)
RandomVariables = build_pydantic_models(schema_properties=schemas_props)
